...
def _setup_llm(mock_llm_client, *, return_value=None):
    ...
    so that await works inside the service.  _settings.llm_model is
    needed because the service constructs an LLMCallRequest with
    model=llm._settings.llm_model (Pydantic validates it as str).
    """
...
async def test_extract_creates_entities(
    mock_llm_client,
    mock_load_prompt,
    mock_get_context,
    mock_find_entity,
...
async def test_action_handling(
    mock_llm_client,
    mock_load_prompt,
    mock_get_context,
    mock_find_entity,
...
async def test_llm_error_marks_failed(
    mock_llm_client,
    mock_load_prompt,
    mock_get_context,
    mock_find_entity,
...
@mock.patch("infrastructure.llm.prompt_loader.load_prompt")
@mock.patch("infrastructure.llm.client.LLMClient")
async def test_dedup_name_embedding_match(
    mock_llm_client,
    mock_load_prompt,
    mock_get_context,
    mock_find_entity,
...
@mock.patch("infrastructure.llm.prompt_loader.load_prompt")
@mock.patch("infrastructure.llm.client.LLMClient")
async def test_dedup_content_embedding_match(
    mock_llm_client,
    mock_load_prompt,
    mock_get_context,
    mock_find_entity,
    ...
    # Layer 1: no match.  Layer 2: content embedding match.
...
@mock.patch("infrastructure.llm.prompt_loader.load_prompt")
@mock.patch("infrastructure.llm.client.LLMClient")
async def test_empty_entities_continues(
    mock_llm_client,
    mock_load_prompt,
    mock_get_context,
    mock_find_entity,
...
@mock.patch("infrastructure.llm.prompt_loader.load_prompt")
@mock.patch("infrastructure.llm.client.LLMClient")
async def test_empty_name_skipped(
    mock_llm_client,
    mock_load_prompt,
    mock_get_context,
    mock_find_entity,
...
@mock.patch("infrastructure.llm.prompt_loader.load_prompt")
@mock.patch("infrastructure.llm.client.LLMClient")
async def test_empty_chapters_raises(
    mock_llm_client,
    mock_load_prompt,
    mock_get_context,
    mock_find_entity,
