...
- 职业或任职属性不等于实际称呼：“某人是一名医生/担任某职”只证明其职业，不能据此生成“医生/某职”的 title 别名。只有正文确实以该称号称呼、命名或识别此人，且能稳定指向同一对象时，才登记称谓；不能因职业可能长期保持就推断称呼也成立。
...
- “首次可靠揭示”只描述本次资料中获得一条可登记的关系，不证明故事历史上此刻才建立。候选表为空、检索未命中、处于读取链头，都不能证明此前关系不存在；只有正文明确说明“刚刚结盟”等建立事件时才能写此刻建立。否则依据写“当前正文明确陈述该关系，既往起点未说明”，不要从缺少记录推出“此前无前例，故首次建立”。
