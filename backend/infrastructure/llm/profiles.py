...
PROVIDER_TEMPLATES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "description": "阿里云百炼 OpenAI 兼容模式；请将 {WorkspaceId} 替换为业务空间 ID",
        "docs_url": (
    ...
    },
    {
        ...
        "description": "百川 OpenAI-compatible API；如控制台显示不同端点，以控制台为准",
    ...
    },
    {
        ...
        "description": "MiniMax OpenAI-compatible API；模型名可按控制台调整",
    ...
    },
    {
        ...
        "description": "腾讯混元 OpenAI-compatible API；模型名可按控制台调整",
    ...
    },
    {
        ...
        "description": "百度千帆 OpenAI-compatible API；模型名可按控制台调整",
    ...
    },
    {
        ...
        "description": "阶跃星辰 OpenAI-compatible API；模型名可按控制台调整",
    ...
    },
    {
        ...
        "description": "零一万物 OpenAI-compatible API；模型名可按控制台调整",
