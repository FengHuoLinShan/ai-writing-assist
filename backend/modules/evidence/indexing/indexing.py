...
from modules.evidence.indexing.embedding_writer import (
    EmbeddingWriter,
...
from modules.evidence.indexing.source_collection import collect_chapter_sources
...
class IndexingService:
    ...
    async def index_chapter_for_task(
        ...
        *,
        ...
        from modules.evidence.indexing.index_state import (
            RagIndexOwnerToken,
