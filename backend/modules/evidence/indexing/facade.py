...
from modules.evidence.indexing.mappers import chunk_orm_to_contract as _to_chunk_contract
...
from modules.evidence.indexing.schemas import RagChunkCreate, RagChunkResponse
...
async def get_scene_mapping_coverage(
    ...
    *,
    ...
    from modules.evidence.indexing.scene_mapping_coverage import (
        RagSceneMappingCoverageService,
    )
