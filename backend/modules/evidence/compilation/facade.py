...
from modules.evidence.compilation.services import (
    ContextCompiler,
...
from modules.evidence.compilation.services.generation_background import (
    GenerationBackgroundRequest,
    GenerationBackgroundService,
)
from modules.evidence.compilation.services.hidden_guard import (
    HiddenGuardBuilder,
    HiddenGuardTerm,
)
...
def _evidence_health_service():
    from modules.evidence.compilation.services.evidence_health_service import (
...
async def retrieve_planned_context_evidence(
    ...
    *,
    ...
    from modules.evidence.compilation.services.planned_retrieval_service import (
