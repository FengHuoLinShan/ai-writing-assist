...
async def test_outline_analysis_range_is_not_loaded_for_reader_view(
    ...
    from modules.evidence.compilation.services.context_compiler import ContextCompiler
    from modules.evidence.compilation.services.loaders.outline_analysis_loader import (
...
async def test_world_bible_loader_pins_actual_synopsis_provenance(
    ...
    from modules.evidence.compilation.services.loaders.world_bible_loader import (
        WorldBibleLoader,
    )
...
class TestContextSnapshot:
    ...
    async def test_snapshot_success_failure_and_prune(
        ...
        from modules.evidence.compilation.facade import get_context_snapshot
...
class TestContextConfirmation:
    ...
    async def test_excluding_context_section_removes_non_p0_section(
        ...
        monkeypatch.setattr("modules.evidence.indexing.facade.retrieve", _fake_retrieve)
    ...
    async def test_list_by_asset_ref_ignores_malformed_result_refs(
        ...
        from modules.evidence.compilation.repositories import (
            ContextConfirmationRepository,
        )
