...
- 按需聚合 `project / world / memory / outline / evidence/indexing`
...
Activation Profile 属于 Evidence compilation，不属于 World Bible 页面。规则只支持声明过的 action、
...
`compile_interaction_story_context()` 默认仍要求 source 与 interaction consumer 同 owner。ADR-0024 的
