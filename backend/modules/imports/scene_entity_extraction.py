"""Compatibility shell for the Phase 2 Scene entity extraction service.

New imports should use ``modules.imports.entity_extraction``. This module stays
as the stable legacy monkeypatch path for existing integrations and tests.
"""
