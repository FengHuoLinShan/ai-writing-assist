    ...
    async def extract_by_scenes(
        ...
        *,
        ...
        route = SceneEntityExtractionStrategySelector.select(
            ...
            has_checkpoints=bool(checkpoint_by_scene),
            small_sample_min=PHASE2_SMALL_SAMPLE_MIN_SCENES,
            bulk_max=PHASE2_BULK_MAX_SCENES,
        )
        if route.strategy == "empty":
            return {
                "total_created": 0,
                "total_relations": 0,
                "total_aliases": 0,
        ...
        if route.strategy == "small_sample_parallel":
