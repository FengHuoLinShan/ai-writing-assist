"""World co-creation session and message ORM models (ADR-0021)."""
...
class WorldCocreationSession(Base, UUIDMixin, TimestampMixin):
...
class WorldCocreationMessage(Base, UUIDMixin, TimestampMixin):
