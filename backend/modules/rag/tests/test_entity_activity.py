...
from modules.rag.models import RagEntityAppearance, RagIndexState
...
async def test_activity_prefers_fresh_working_and_ignores_stale_hash_and_other_novel(
    ...
    monkeypatch.setattr(
        "modules.rag.entity_activity._container_get",
...
async def test_reannotation_term_load_failure_preserves_existing_projection(
    ...
    monkeypatch.setattr(
        "modules.rag.entity_activity._load_project_terms",
        fail_terms,
    )
