...
async def commit_deep_import_scene_candidates(
    ...
    *,
    ...
    from modules.story.outline_state.scene_replacement import DeepImportSceneCommitService
...
async def get_scene_span_coverage(
    ...
    *,
    ...
    from modules.story.outline_state.scene_coverage import SceneSpanCoverageService
...
async def bind_scene_spans_to_source(
    ...
    *,
    ...
    from modules.story.outline_state.scene_source_service import SceneSourceService
