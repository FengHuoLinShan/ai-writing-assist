CREATE TABLE async_tasks (
	...
	id UUID NOT NULL, 
	created_at DATETIME DEFAULT (timezone('utc', CURRENT_TIMESTAMP)) NOT NULL, 
	updated_at DATETIME DEFAULT (timezone('utc', CURRENT_TIMESTAMP)), 
	PRIMARY KEY (id)
);
...
CREATE TABLE context_snapshots (
	...
	error_message TEXT, 
	rendered_context_expires_at DATETIME, 
	created_at DATETIME DEFAULT (timezone('utc', CURRENT_TIMESTAMP)) NOT NULL, 
	updated_at DATETIME DEFAULT (timezone('utc', CURRENT_TIMESTAMP)), 
	PRIMARY KEY (id), 
	FOREIGN KEY(novel_id) REFERENCES projects (id) ON DELETE CASCADE
