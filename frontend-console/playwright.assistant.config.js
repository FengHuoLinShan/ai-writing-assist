...
const config = createE2EConfig({ profile: "assistant integration", testMatch: "assistant.spec.js", timeout: 60000 })
...
Object.assign(config.webServer[0].env, { APP_ENV: "test", AUTH_MODE: "local", ASSISTANT_ENABLED: "1", ASSISTANT_BROWSER_HARNESS: "1", RAG_PREWARM_ON_STARTUP: "0" })
