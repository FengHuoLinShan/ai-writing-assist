...
globalThis.api = {
  ...
  world: {
    ...
    updateMap: vi.fn(),
    deleteMap: vi.fn(),
    getMapArchiveImpact: vi.fn(),
    archiveMap: vi.fn(),
    restoreMap: vi.fn(),
    applyMapEditor: vi.fn(),
    getMapLayerTree: vi.fn(),
    getMapPaths: vi.fn(),
    getMapPathArchiveImpact: vi.fn(),
    getEntityMapPresence: vi.fn(),
    generateMap: vi.fn(),
    getMapState: vi.fn(),
    getMapDynamicState: vi.fn(),
    getMapDashboard: vi.fn(),
    getMapPlayback: vi.fn(),
    getMapTimeline: vi.fn(),
    getMapStateAt: vi.fn(),
    ...
    updateTerrainLayer: vi.fn(),
    deleteTerrainLayer: vi.fn(),
