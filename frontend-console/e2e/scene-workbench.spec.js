...
test.describe("Scene 工作台", () => {
  ...
  test("热点进度分段清楚并在导航与作品切换后恢复", async ({ page, browserErrors }) => {
    ...
    try {
      ...
      await page.screenshot({ path: "/Users/tywww/.codex/visualizations/2026/08/22/01a029ee-6daf-72f0-8ce5-e79389d40439/outline-scene-overview-after-mobile-night.png", fullPage: true })
      ...
      await expect(overview).toHaveAttribute("open", "")
      await expect(overviewSummary).toContainText("缺设定 3")
      await page.screenshot({ path: "/Users/tywww/.codex/visualizations/2026/08/22/01a029ee-6daf-72f0-8ce5-e79389d40439/outline-scene-overview-after-mobile-expanded-night.png", fullPage: true })
  ...
  test("选择 Scene 按需打开详情栏，浏览历史与刷新可恢复", async ({ page, browserErrors }) => {
    ...
    await page.screenshot({ path: "/Users/tywww/.codex/visualizations/2026/08/22/01a029ee-6daf-72f0-8ce5-e79389d40439/outline-scene-detail-after-list-first.png", fullPage: true })
    ...
    await page.screenshot({ path: "/Users/tywww/.codex/visualizations/2026/08/22/01a029ee-6daf-72f0-8ce5-e79389d40439/outline-scene-detail-actions-after.png", fullPage: true })
    ...
    await page.screenshot({ path: "/Users/tywww/.codex/visualizations/2026/08/22/01a029ee-6daf-72f0-8ce5-e79389d40439/outline-scene-detail-actions-menu-open.png", fullPage: true })
    ...
    await detailMore.press("ArrowDown")
    await expect(mergeScene).toBeFocused()
    await page.screenshot({ path: "/Users/tywww/.codex/visualizations/2026/08/22/01a029ee-6daf-72f0-8ce5-e79389d40439/outline-scene-detail-actions-after-night.png", fullPage: true })
  ...
  test("窄屏场景详情可补全、保存、返回并恢复", async ({ page, browserErrors }) => {
    ...
    try {
      ...
      await page.screenshot({ path: "/Users/tywww/.codex/visualizations/2026/08/22/01a029ee-6daf-72f0-8ce5-e79389d40439/outline-scene-detail-actions-after-mobile.png", fullPage: true })
      ...
      await page.screenshot({ path: "/Users/tywww/.codex/visualizations/2026/08/22/01a029ee-6daf-72f0-8ce5-e79389d40439/outline-scene-detail-actions-menu-open-mobile.png", fullPage: true })
      await page.keyboard.press("Escape")
      await expect(dialog).toBeVisible()
