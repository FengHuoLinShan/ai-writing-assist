...
export const DEFAULT_COLORS = Object.freeze({
  light: Object.freeze({ background: '#F6F6F8', surface: '#FFFFFF', muted: '#EEEEF1', text: '#202027', body: '#41414B', secondary: '#656570', accent: '#4F46E5', onAccent: '#FFFFFF', primary: '#25252D', onPrimary: '#FFFFFF', border: '#DDDDE3', controlBorder: '#83838F', success: '#24714D', warning: '#8A580D', danger: '#B63845' }),
  dark: Object.freeze({ background: '#141416', surface: '#1E1E22', muted: '#2B2B31', text: '#F4F4F5', body: '#DEDEE3', secondary: '#B0B0BC', accent: '#B2B9FF', onAccent: '#1C1B33', primary: '#EDEDF2', onPrimary: '#202027', border: '#38383F', controlBorder: '#7C7C89', success: '#8ED2AE', warning: '#ECC282', danger: '#FFA3AA' }),
})
