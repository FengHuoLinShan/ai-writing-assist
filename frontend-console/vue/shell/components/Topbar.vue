<template>
  <header id="topbar">
    <div class="topbar-left"><div class="logo"><span class="logo-mark">◆</span><span class="logo-name">NovelCraft</span></div></div>
    <div class="topbar-center">
      <span id="topbar-project" :title="projectTitle">{{ projectTitle }}</span><span class="separator">·</span>
