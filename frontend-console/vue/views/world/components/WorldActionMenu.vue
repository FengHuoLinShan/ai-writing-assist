<!--
  WorldActionMenu — 行内"更多操作"下拉，DOM 契约对齐 shared/viewHelper.js
  renderActionMenu（.action-menu > .action-menu-btn + .action-menu-list >
  .action-menu-item[data-action][data-*]）。开合状态 Vue 内聚：vanilla 靠
  bindActionMenus 逐个绑定 + 全局 document click 关闭，此处等价实现。
-->
<template>
