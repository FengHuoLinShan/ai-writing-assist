...
(function () {
  ...
  const API_CONTRACTS = Object.freeze({
    ...
    "world.createMapNode": define("POST", ({ novelId }) => `/world/map-atlas/${required(novelId, "novelId", "world.createMapNode")}/nodes`, { requiredParams: ["novelId"], hasBody: true, requiredBody: ["title", "level"] }),
    "world.getNodeMap": define("GET", ({ novelId, nodeId }) => `/world/map-atlas/${required(novelId, "novelId", "world.getNodeMap")}/nodes/${required(nodeId, "nodeId", "world.getNodeMap")}/map`, { requiredParams: ["novelId", "nodeId"] }),
    "world.saveMapRevision": define("POST", ({ novelId, nodeId }) => `/world/map-atlas/${required(novelId, "novelId", "world.saveMapRevision")}/nodes/${required(nodeId, "nodeId", "world.saveMapRevision")}/revisions`, { requiredParams: ["novelId", "nodeId"], hasBody: true, requiredBody: ["base_revision_id", "document"] }),
    "world.listMapRevisions": define("GET", ({ novelId, nodeId }) => `/world/map-atlas/${required(novelId, "novelId", "world.listMapRevisions")}/nodes/${required(nodeId, "nodeId", "world.listMapRevisions")}/revisions`, { requiredParams: ["novelId", "nodeId"] }),
    "world.layoutMap": define("POST", ({ novelId, nodeId }) => `/world/map-atlas/${required(novelId, "novelId", "world.layoutMap")}/nodes/${required(nodeId, "nodeId", "world.layoutMap")}/layout`, { requiredParams: ["novelId", "nodeId"], hasBody: true, requiredBody: ["base_revision_id", "document"] }),
    "world.generateMapStructure": define("POST", ({ novelId, nodeId }) => `/world/map-atlas/${required(novelId, "novelId", "world.generateMapStructure")}/nodes/${required(nodeId, "nodeId", "world.generateMapStructure")}/generate-structure`, { requiredParams: ["novelId", "nodeId"], hasBody: true, requiredBody: ["operation_id", "base_revision_id", "context_confirmation_id", "location_ids"], timeout: AI_TASK_SUBMIT_TIMEOUT }),
    "world.reviewMapRevision": define("POST", ({ novelId, nodeId, revisionId }) => `/world/map-atlas/${required(novelId, "novelId", "world.reviewMapRevision")}/nodes/${required(nodeId, "nodeId", "world.reviewMapRevision")}/revisions/${required(revisionId, "revisionId", "world.reviewMapRevision")}/review`, { requiredParams: ["novelId", "nodeId", "revisionId"], hasBody: true, requiredBody: ["base_revision_id", "action"], timeout: AI_PREVIEW_APPLY_TIMEOUT }),
    "world.previewReaderMap": define("GET", ({ novelId, nodeId }) => `/world/map-atlas/${required(novelId, "novelId", "world.previewReaderMap")}/nodes/${required(nodeId, "nodeId", "world.previewReaderMap")}/reader-preview`, { requiredParams: ["novelId", "nodeId"], requiredQuery: ["chapter"] }),
