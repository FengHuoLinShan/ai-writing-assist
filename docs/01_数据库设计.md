...
| 世界书 | `world_bible_categories`, `world_bible_page_drafts`, `world_bible_pages`, `world_bible_page_revisions`, `world_bible_page_projections` | 自定义类别、服务器工作稿、发布页、版本快照和可编译投影分离；发布以 `base_version_number` 做 CAS，页面/版本唯一。 |
