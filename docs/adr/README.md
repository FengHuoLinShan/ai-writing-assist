...
| [ADR-0021](0021-world-cocreation-session-persistence.md) | Accepted / Partially implemented | 共创终态消息和 checkpoint 指针已持久化并以 CAS 推进；完整历史阅读界面、同步聊天回执和完整 world-state 增量续写尚未完成，不自动采用。 |
