...
- 当前里程碑：R5 完成，X2-3a 后端完成；取消仍只停止任务，显式 cleanup 复用现有软回滚并保存 fingerprint/idempotent receipt。
- 下一步：实施 X2-3b/c，在 ImportDrawer 增加“导入记录/回收站”Tab、预览确认、partial 重试及桌面/390px 浏览器链。
