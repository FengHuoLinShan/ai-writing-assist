...
| R5 | R5a–R5c 已完成 | 六维契约、导入/投影及确定性三类规则完成；地图仅经 adopted saved revision + 新鲜来源只读 seam 消费，缺证据只标未检查。R5d–f 待实施；见[实施细案](../2026/T-20260911-full-codebase-optimization-implementation/authorized-remaining-plan.md) |
